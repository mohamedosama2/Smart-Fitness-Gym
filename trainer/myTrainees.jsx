...
//         </div>
//         <i
//           className={`material-icons arrow_up ${style.arrows} ${style.arrow_up}`}
//         >
//           keyboard_arrow_up
//         </i>
//         <i
//           className={`material-icons arrow_down ${style.arrows} ${style.arrow_down}`}
//         >
//           keyboard_arrow_down
//         </i>
//       </div>
...
//                     {profile?profile.images?profile.images.length>0? profile.images.map((i, index) => {
//                       return (
//                         <div key={index}>
...
//                 </div>
//                 <a
//                   className={` carousel-control-prev ${style.carousel_control_prev}`}
//                 >
//                   <span
...
//                 </a>
//                 <a
//                   className={`carousel-control-next ${style.carousel_control_next}`}
//                 >
//                   <span
...
//             <div>
//               <i
//                 className={`material-icons arrow_back ${style.arrow} ${style.arrow_back}`}
//               >
//                 arrow_back
//               </i>
//               <i
//                 className={`material-icons arrow_forward ${style.arrow} ${style.arrow_forward}`}
//               >
//                 arrow_forward
//               </i>
//             </div>
