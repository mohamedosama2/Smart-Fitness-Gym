...
import EmailIcon from '@material-ui/icons/Email'; // FIXME chnge color to #d9a404 yellow
        ...
        <div className={style.login}>
          <form >
            ...
            <div className="Authes">
                ...
                <div className="AuthType">
                    <input type="radio" value="phone" name="phone"  onClick={e=>this.setState({radio:e.target.value})} />
                    <img src={phone} alt="phone img"  />
                    <div>
                        <h4>Send code via SMS</h4>
                        <h5>+***********28</h5>
                ...
                <div className="AuthType">
                    <input type="radio" value="email" name="phone" onClick={e=>this.setState({radio:e.target.value})} />
                    <EmailIcon />
                    <div>
                        <h4>Send code via E-mail</h4>
                        <h5>***********.com</h5>
            ...
            <hr />
            <button type="submit" className={style.btn} onClick={(e)=>{
                e.preventDefault()
             return this.state.radio!==""? this.props.openHandler2("/signup",this.state.radio):""}}>Choose</button>
