...
//   // useEffect(() => {
//   //   if (props.currentContact&&props.currentContact['username']) {
//   //     // console.log(props.contactForMessage);
//   //     serCurrentContact(props.contactForMessage);
//   //   }
...
//         // console.log(current);
//         // console.log(body);
//         // console.log(body.chat.me === current);
//         // console.log(body.chat.to === current);
//         if (body.chat.me === current || body.chat.to === current) {
...
//               props.addMessage(message,props.currentContact);
//               setMessage("");
